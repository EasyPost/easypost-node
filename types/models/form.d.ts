...
export default class Form extends EasyPostObject {
    form_type?: 'cn22' | 'cod_return_label' | 'commercial_invoice' | 'high_value_report' | 'label_qr_code' | 'nafta_certificate_of_origin' | 'order_summary' | 'return_packing_slip' | 'rma_qr_code';
