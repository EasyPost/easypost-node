...
__exportStar(require("./CarrierTypeCredentials"), exports);
__exportStar(require("./CarrierTypeFields"), exports);
exports.default = (function (easypostClient) {
    ...
    return /** @class */ (function (_super) {
        __extends(CarrierTypeService, _super);
        function CarrierTypeService() {
         ...
         */
        CarrierTypeService.all = function (params) {
