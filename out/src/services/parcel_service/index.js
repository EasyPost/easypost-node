...
__exportStar(require("./ParcelCreateParameters"), exports);
exports.default = (function (easypostClient) {
    ...
    return /** @class */ (function (_super) {
        __extends(ParcelService, _super);
         ...
         */
        ParcelService.create = function (params) {
         ...
         */
        ParcelService.retrieve = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var url;
                return __generator(this, function (_a) {
                    url = "parcels/".concat(id);
