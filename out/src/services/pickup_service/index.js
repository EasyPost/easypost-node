...
exports.default = (function (easypostClient) {
    ...
    return /** @class */ (function (_super) {
        __extends(PickupService, _super);
         ...
         */
        PickupService.create = function (params) {
         ...
         */
        PickupService.buy = function (id, carrier, service) {
            return __awaiter(this, void 0, void 0, function () {
                var url, wrappedParams, response, e_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            url = "pickups/".concat(id, "/buy");
         ...
         */
        PickupService.cancel = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var url, response, e_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            url = "pickups/".concat(id, "/cancel");
                            _a.label = 1;
                        case 1:
                            _a.trys.push([1, 3, , 4]);
         ...
         */
        PickupService.all = function (params) {
         ...
         */
        PickupService.getNextPage = function (pickups, pageSize) {
            if (pageSize === void 0) { pageSize = null; }
            return __awaiter(this, void 0, void 0, function () {
                var url;
                return __generator(this, function (_a) {
                    url = "pickups";
                    return [2 /*return*/, this._getNextPage(url, "pickups", pickups, pageSize)];
                });
            });
        };
        /**
         ...
         */
        PickupService.retrieve = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var url;
                return __generator(this, function (_a) {
                    url = "pickups/".concat(id);
