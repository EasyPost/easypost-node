...
exports.default = (function (easypostClient) {
    ...
    return /** @class */ (function (_super) {
         ...
         */
        ApiKeyService.all = function (params) {
         ...
         */
        ApiKeyService.retrieveApiKeysForUser = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var url, response, user, childUser, e_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            url = "api_keys";
                        ...
                        case 2:
                            response = _a.sent();
                            user = this._convertToEasyPostObject(response.body);
                            if (user.id == id) {
                                return [2 /*return*/, user.keys];
                            }
                            childUser = user.children.find(function (child) { return child.id === id; });
                            if (childUser) {
                                return [2 /*return*/, childUser.keys];
                            }
                            return [3 /*break*/, 4];
                        case 3:
                            e_1 = _a.sent();
                            return [2 /*return*/, Promise.reject(e_1)];
                        case 4: throw new filtering_error_1.default({
                            message: node_util_1.default.format(constants_1.default.NO_OBJECT_FOUND, "child"),
                        });
                    }
                });
            });
