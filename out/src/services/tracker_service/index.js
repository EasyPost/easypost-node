...
__exportStar(require("./CarrierDetail"), exports);
__exportStar(require("./Tracker"), exports);
__exportStar(require("./TrackerCreateParameters"), exports);
__exportStar(require("./TrackerListParameters"), exports);
__exportStar(require("./TrackerStatus"), exports);
__exportStar(require("./TrackerStatusDetail"), exports);
__exportStar(require("./TrackingDetail"), exports);
__exportStar(require("./TrackingLocation"), exports);
exports.default = (function (easypostClient) {
    ...
    return /** @class */ (function (_super) {
        __extends(TrackerService, _super);
         ...
         */
        TrackerService.create = function (params) {
         ...
         */
        TrackerService.createList = function (params) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            url = "trackers/create_list";
                            return [4 /*yield*/, easypostClient._post(url, newParams)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
         ...
         */
        TrackerService.all = function (params) {
            if (params === void 0) { params = {}; }
            return __awaiter(this, void 0, void 0, function () {
                var url;
                return __generator(this, function (_a) {
         ...
         */
        TrackerService.getNextPage = function (trackers, pageSize) {
            if (pageSize === void 0) { pageSize = null; }
            return __awaiter(this, void 0, void 0, function () {
                var url;
                return __generator(this, function (_a) {
                    url = "trackers";
                    return [2 /*return*/, this._getNextPage(url, "trackers", trackers, pageSize)];
                });
            });
        };
        /**
         ...
         */
        TrackerService.retrieve = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var url;
                return __generator(this, function (_a) {
                    url = "trackers/".concat(id);
