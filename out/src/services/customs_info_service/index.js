...
__exportStar(require("./CustomsInfo"), exports);
__exportStar(require("./CustomsInfoCreateParameters"), exports);
exports.default = (function (easypostClient) {
    ...
    return /** @class */ (function (_super) {
        __extends(CustomsInfoService, _super);
        function CustomsInfoService() {
         ...
         */
        CustomsInfoService.create = function (params) {
         ...
         */
        CustomsInfoService.retrieve = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var url;
                return __generator(this, function (_a) {
                    url = "customs_infos/".concat(id);
