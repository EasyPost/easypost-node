...
__exportStar(require("./EndShipper"), exports);
__exportStar(require("./EndShipperCreateParameters"), exports);
__exportStar(require("./EndShipperListParameters"), exports);
exports.default = (function (easypostClient) {
    ...
    return /** @class */ (function (_super) {
        __extends(EndShipperService, _super);
        function EndShipperService() {
         ...
         */
        EndShipperService.create = function (params) {
         ...
         */
        EndShipperService.update = function (id, params) {
            return __awaiter(this, void 0, void 0, function () {
                var url, wrappedParams, response, e_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            url = "end_shippers/".concat(id);
                            wrappedParams = { address: params };
                            _a.label = 1;
                        case 1:
                            _a.trys.push([1, 3, , 4]);
         ...
         */
        EndShipperService.retrieve = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var url;
                return __generator(this, function (_a) {
                    url = "end_shippers/".concat(id);
         ...
         */
        EndShipperService.all = function (params) {
