...
__exportStar(require("./CarrierMetadata"), exports);
exports.default = (function (easypostClient) {
    return /** @class */ (function (_super) {
        __extends(CarrierMetadataService, _super);
        function CarrierMetadataService() {
         ...
         */
        CarrierMetadataService.retrieve = function (carriers, types) {
            if (carriers === void 0) { carriers = null; }
            if (types === void 0) { types = null; }
            return __awaiter(this, void 0, void 0, function () {
                var url, params, response, e_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            url = "metadata/carriers";
                            params = __assign(__assign({}, (carriers &&
                                carriers.length > 0 && { carriers: carriers.join(",") })), (types && types.length > 0 && { types: types.join(",") }));
                            _a.label = 1;
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                        ...
                        case 2:
                            response = _a.sent();
                            return [2 /*return*/, this._convertToEasyPostObject(response.body.carriers || [], params)];
                        case 3:
                            e_1 = _a.sent();
