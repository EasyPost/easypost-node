...
__exportStar(require("./WebhookListParameters"), exports);
exports.default = (function (easypostClient) {
    ...
    return /** @class */ (function (_super) {
        __extends(WebhookService, _super);
         ...
         */
        WebhookService.create = function (params) {
         ...
         */
        WebhookService.update = function (id, params) {
            return __awaiter(this, void 0, void 0, function () {
                var url, response, e_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            url = "webhooks/".concat(id);
                            _a.label = 1;
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, easypostClient._patch(url, params)];
                        case 2:
                            response = _a.sent();
         ...
         */
        WebhookService.delete = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var url, e_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
         ...
         * @returns
         */
        WebhookService.all = function (params) {
         ...
         */
        WebhookService.retrieve = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var url;
                return __generator(this, function (_a) {
                    url = "webhooks/".concat(id);
