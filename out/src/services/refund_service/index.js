...
__exportStar(require("./RefundCreateParameters"), exports);
__exportStar(require("./RefundListParameters"), exports);
exports.default = (function (easypostClient) {
    ...
    return /** @class */ (function (_super) {
        __extends(RefundService, _super);
         ...
         */
        RefundService.create = function (params) {
         ...
         */
        RefundService.all = function (params) {
         ...
         */
        RefundService.getNextPage = function (refunds, pageSize) {
            if (pageSize === void 0) { pageSize = null; }
            return __awaiter(this, void 0, void 0, function () {
                var url;
                return __generator(this, function (_a) {
                    url = "refunds";
                    return [2 /*return*/, this._getNextPage(url, "refunds", refunds, pageSize)];
                });
            });
        };
        /**
         ...
         */
        RefundService.retrieve = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var url;
                return __generator(this, function (_a) {
                    url = "refunds/".concat(id);
