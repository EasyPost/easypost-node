...
exports.default = (function (easypostClient) {
    return /** @class */ (function (_super) {
        __extends(BetaRateService, _super);
        function BetaRateService() {
         ...
         */
        BetaRateService.retrieveStatelessRates = function (params) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            response = _a.sent();
                            return [2 /*return*/, this._convertToEasyPostObject(response.body.rates, wrappedParams)];
                        case 3:
                            e_1 = _a.sent();
