...
__exportStar(require("./CustomsItemCreateParameters"), exports);
exports.default = (function (easypostClient) {
    ...
    return /** @class */ (function (_super) {
        __extends(CustomsItemService, _super);
        function CustomsItemService() {
         ...
         */
        CustomsItemService.create = function (params) {
         ...
         */
        CustomsItemService.retrieve = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var url;
                return __generator(this, function (_a) {
                    url = "customs_items/".concat(id);
                    return [2 /*return*/, this._retrieve(url)];
                });
            });
        };
        return CustomsItemService;
