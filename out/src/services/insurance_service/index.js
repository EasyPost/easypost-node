...
__exportStar(require("./InsuranceCreateParameters"), exports);
__exportStar(require("./InsuranceStatus"), exports);
exports.default = (function (easypostClient) {
    ...
    return /** @class */ (function (_super) {
        __extends(InsuranceService, _super);
         ...
         */
        InsuranceService.create = function (params) {
         ...
         */
        InsuranceService.all = function (params) {
         ...
         */
        InsuranceService.getNextPage = function (insurances, pageSize) {
            if (pageSize === void 0) { pageSize = null; }
            return __awaiter(this, void 0, void 0, function () {
                var url;
                return __generator(this, function (_a) {
                    url = "insurances";
                    return [2 /*return*/, this._getNextPage(url, "insurances", insurances, pageSize)];
                });
            });
        };
        /**
         ...
         */
        InsuranceService.retrieve = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var url;
                return __generator(this, function (_a) {
                    url = "insurances/".concat(id);
